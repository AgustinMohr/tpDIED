...
class GestorTest {
	...
	void testAgregarLinea() {
		...
		assertTrue(g.getListaLineas().contains(s1));
		assertTrue(g.getListaLineas().contains(e1));
	}

	@Test
	void testAgregarParada() {
		g.agregarParada(p1);
		g.agregarParada(p2);
		g.agregarParada(p3);
		g.agregarParada(p4);
		...
		assertTrue(g.getListaParadas().containsAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12)));
	}

	@Test
	@Disabled("Ver para eliminar metodo")
	void testAgregarCaminoParadaParadaDouble() {
		
	}

	@Test
	void testAgregarCaminoCamino() {
		g.agregarCamino(c1);
		g.agregarCamino(c2);
		g.agregarCamino(c3);
		g.agregarCamino(c4);
		...
		assertTrue(g.getListaCaminos().containsAll(Arrays.asList(c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, c16, c17, c18, c19, c20, c21, c22)));
	}

	@Test
	@Disabled("Ver para eliminar metodo")
	void testAgregarIncidenteStringStringStringParada() {
		fail("Not yet implemented");
	}

	@Test
	void testAgregarIncidenteLocalDateLocalDateStringParada() {
	...
	@Test
	void testTerminarIncidente() {
		fail("Not yet implemented");
	}

	@Test
	void testGetAdyacentes() {
		fail("Not yet implemented");
	}
	...
	@Test
	void testDistanciaEntreDosParadas() {
		fail("Not yet implemented");
	}

	@Test
	void testBuscarCaminos() {
		fail("Not yet implemented");
	}

	@Test
	void testTrayectoDeUnaLinea() {
		fail("Not yet implemented");
	}

	@Test
	void testComprarBoleto() {
		fail("Not yet implemented");
	}
